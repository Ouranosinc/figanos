"""Uncertainty partitioning module.
...
def graph_variance(variance: xr.DataArray, ref: str = "2000", ax: mpl.ax.Axes = None):
...
def graph_fractional_uncertainty(
    mm: xr.DataArray, variance: xr.DataArray, ref: str = "2000", ax: mpl.ax.Axes = None
):
...
def graph_fraction_of_total_variance(
    variance: xr.DataArray, ref: str = "2000", ax: mpl.ax.Axes = None
):
...
def add_lead_time_coord(da: xr.DataArray, ref: str) -> xr.DataArray:
